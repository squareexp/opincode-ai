import { ArrowSwapVertical, TickCircle, ArrowUp2, ArrowDown2 } from 'iconsax-react';
  ...
  return (
    ...
    >
      ...
      <SelectPrimitive.Icon asChild>
        <ArrowSwapVertical variant="Linear" className="pointer-events-none size-4 text-muted-foreground"  color="currentColor"/>
    ...
    >
      <span className="pointer-events-none absolute right-2 flex size-4 items-center justify-center">
        <SelectPrimitive.ItemIndicator>
          <TickCircle variant="Linear" className="pointer-events-none"  color="currentColor"/>
        </SelectPrimitive.ItemIndicator>
      </span>
...
function SelectScrollUpButton({
  ...
  return (
    <SelectPrimitive.ScrollUpButton
      ...
      {...props}
    >
      <ArrowUp2 variant="Linear"  color="currentColor"/>
    </SelectPrimitive.ScrollUpButton>
  )
}
...
function SelectScrollDownButton({
  ...
  return (
    <SelectPrimitive.ScrollDownButton
      ...
      {...props}
    >
      <ArrowDown2 variant="Linear"  color="currentColor"/>
    </SelectPrimitive.ScrollDownButton>
  )
}
