  ...
  return (
    <div data-slot="command-input-wrapper" className="p-1 pb-0">
      <InputGroup className="h-9 bg-input/50">
        ...
        />
        <InputGroupAddon>
          <SearchNormal1 variant="Linear" className="size-4 shrink-0 opacity-50"  color="currentColor"/>
        </InputGroupAddon>
      </InputGroup>
    </div>
  )
...
function CommandItem({
  ...
  return (
    ...
    >
      {children}
      <TickCircle variant="Linear" className="ml-auto opacity-0 group-has-data-[slot=command-shortcut]/command-item:hidden group-data-[checked=true]/command-item:opacity-100"  color="currentColor"/>
    </CommandPrimitive.Item>
  )
}
