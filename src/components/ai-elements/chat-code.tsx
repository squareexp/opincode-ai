...
function RunInTerminalButton({ command }: { command: string }) {
  ...
  return (
    ...
    >
      {sent ? (
        <Code1 variant="Linear" size={11} color="currentColor" className="shrink-0" />
      ) : (
        <ArrowRight2 variant="Linear" size={11} color="currentColor" className="shrink-0" />
      )}
...
function CopyButton({ text }: { text: string }) {
  ...
  return (
    ...
    >
      {copied ? (
        <TickCircle variant="Linear" size={11} color="currentColor" className="shrink-0" />
      ) : (
        <Copy variant="Linear" size={11} color="currentColor" className="shrink-0" />
      )}
    </Button>
  );
}
