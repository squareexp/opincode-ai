import { Edit2, Add } from 'iconsax-react';
      ...
      >
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-1.5">
            ...
            >
              <Add variant="Linear" size={11}  color="currentColor"/>
              Create
            </Button>
            <Button
              variant="outline"
            ...
            >
              Import .opincode-theme
            </Button>
          </div>
          <input
            ref={fileInputRef}
            type="file"
            accept=".opincode-theme,.json,application/json"
            className="hidden"
            onChange={(e) => {
              ...
              >
                ...
                {isCustom ? (
                  <span className="ml-1 flex shrink-0 items-center gap-0.5 opacity-0 transition group-hover:opacity-100">
                    ...
                    >
                      <Edit2 variant="Linear" size={12}  color="currentColor"/>
                    </span>
                    <span
                      role="button"
