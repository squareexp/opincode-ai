  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="flex items-center justify-between">
        ...
        >
          <HugeiconsIcon icon={ArrowTurnBackwardIcon} strokeWidth={1.75}
            size={12}
          />
          Reset All
        </Button>
          ...
          <>
            ...
            <div className="flex items-center gap-1">
              {isModified && (
                ...
                >
                  <HugeiconsIcon icon={ArrowTurnBackwardIcon} strokeWidth={1.75} size={12} />
                </Button>
              )}
              <Button
                variant="ghost"
              ...
              >
                <HugeiconsIcon icon={Delete02Icon} strokeWidth={1.75} size={12} />
              </Button>
            </div>
          </>
        )}
