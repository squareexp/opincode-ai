  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="flex flex-col gap-2">
        ...
        <SettingRow
          title="Inline command suggestions"
          description="Show history-based ghost-text suggestions as you type. Press → or End to accept."
        >
          <Switch
      ...
      <div className="flex flex-col gap-2">
        ...
        <SettingRow
          ...
          description="Alert when Claude Code or Codex running in a terminal needs your input or finishes. Desktop notification when OpinCode is unfocused, in-app otherwise."
        >
          <Switch
        ...
        <SettingRow
          title={
            <span className="inline-flex items-center gap-1.5">
              YOLO mode
              <span className="rounded bg-amber-500/15 px-1 py-0.5 text-[9.5px] font-medium text-amber-600 dark:text-amber-400">
                caution
              </span>
            </span>
          }
          description="Auto-approve all AI tool calls (file writes, shell commands) without prompting. Use only in trusted sessions."
        >
          <Switch
            checked={yoloMode}
            onCheckedChange={(v) => void setYoloMode(v)}
          />
        </SettingRow>
      </div>
      ...
      <div className="flex flex-col gap-2">
        ...
        <div className="flex flex-col gap-2">
          <SettingRow
            ...
            description="Open OpinCode automatically when you sign in."
          >
            <Switch
              checked={autostart}
