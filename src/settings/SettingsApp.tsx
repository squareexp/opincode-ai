import { Setting2, Brush, Keyboard, Cpu, People, InfoCircle } from 'iconsax-react';
...
const TABS: { id: SettingsTab; label: string; icon: any, component: () => JSX.Element }[] =
  [
    { id: "general", label: "General", icon: Setting2, component: GeneralSection },
    { id: "themes", label: "Themes", icon: Brush, component: ThemesSection },
    ...
    { id: "agents", label: "Agents", icon: People, component: AgentsSection },
    { id: "about", label: "About", icon: InfoCircle, component: AboutSection },
  ];
        ...
        >
          <TabsList className="mx-auto h-7 bg-muted/40 px-2">
            {TABS.map((t) => (
              ...
              >
                <t.icon variant="Linear" size={12} color="currentColor" />
                <span>{t.label}</span>
              </TabsTrigger>
            ))}
          </TabsList>
