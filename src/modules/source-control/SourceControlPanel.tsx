...
import { Danger, ArrowDown2, ArrowRight2, ArrowUp2, TickCircle, DocumentDownload, FolderConnection, Refresh2 } from 'iconsax-react';


import {  AiContentGenerator02Icon, FolderCloudIcon, GitBranchIcon, RemoveSquareIcon  } from '@hugeicons/core-free-icons';
import {
  AlertDialog,
  AlertDialogAction,
  AlertDialogCancel,
        ...
        <header className="flex shrink-0 items-center justify-between gap-2 border-b border-border/50 px-3 pb-2.5 pt-3">
          <div className="flex min-w-0 items-center gap-1.5">
            <div className="inline-flex min-w-0 items-center gap-1.5 rounded-md bg-foreground/5 px-2 py-1 text-[11.5px] font-medium leading-none text-foreground transition-colors hover:bg-foreground/10">
              <FolderConnection variant="Linear"
                size={12}
          ...
          <div className="flex shrink-0 items-center gap-0.5">
            ...
            >
              {fetchBusy ? (
                ...
                <HugeiconsIcon icon={FolderCloudIcon} strokeWidth={1.75}
                  size={14}
                />
              )}
            </IconActionButton>
                    ...
                    <TooltipTrigger asChild>
                      ...
                      >
                        {scm.actionBusy === "generate-message" ? (
                          ...
                          <HugeiconsIcon icon={AiContentGenerator02Icon} strokeWidth={1.75}
                            size={14}
                          />
                        )}
                      </button>
        ...
        <div className="flex shrink-0 items-center opacity-0 transition-opacity group-hover:opacity-100 data-[focused=true]:opacity-100 data-[selected=true]:opacity-100">
          ...
          >
            {isDiscardBusy ? (
              ...
              <HugeiconsIcon icon={RemoveSquareIcon} strokeWidth={1.75}
                size={11}
              />
            )}
          </IconActionButton>
