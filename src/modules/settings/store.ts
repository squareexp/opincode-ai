...
export const DEFAULT_THEME_ID = "opincode-default";
...
export type Preferences = {
  ...
  /** When true, all AI tool approvals are auto-accepted (YOLO mode). */
  yoloMode: boolean;
...
// window can listen.
const PREFS_CHANGED_EVENT = "opincode://prefs-changed";
...
export async function loadPreferences(): Promise<Preferences> {
  ...
  return {
    ...
    yoloMode: get<boolean>(KEY_YOLO_MODE) ?? DEFAULT_PREFERENCES.yoloMode,
...
export async function setYoloMode(value: boolean): Promise<void> {
  await writePref(KEY_YOLO_MODE, value);
}
...
const KEYS_CHANGED_EVENT = "opincode://ai-keys-changed";
