        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <Button
              ...
              title="New tab"
            >
              <Add variant="Linear" size={14} color="currentColor" />
            </Button>
          </DropdownMenuTrigger>
          <DropdownMenuContent align="start" className="min-w-44">
            <DropdownMenuItem onSelect={() => onNew()}>
              <Code1 variant="Linear" size={14} color="currentColor" className="shrink-0" />
            ...
            <DropdownMenuItem onSelect={() => onNewPreview()}>
              <Global variant="Linear" size={14} color="currentColor" />
            ...
            <DropdownMenuItem onSelect={() => onNewGitGraph()}>
              <FolderConnection variant="Linear" size={14} color="currentColor" className="shrink-0" />
...
function TabIcon({ tab }: { tab: Tab }) {
  ...
  if (tab.kind === "ai-diff") {
    return (
      <ArrowSwapVertical variant="Linear"
        size={14}
        color="currentColor"
        className="shrink-0"
      />
