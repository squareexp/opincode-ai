...
import { FileAddIcon, Folder01Icon, FolderAddIcon } from '@hugeicons/core-free-icons';
import {
  ContextMenu,
  ContextMenuContent,
  ContextMenuItem,
    ...
    return (
      ...
      >
        <div className="flex h-8 shrink-0 items-center gap-1 border-b border-border/60 px-2">
          ...
          >
            <SearchNormal1 color="currentColor" variant="Linear" size={13} />
          </Button>
          ...
          <Button
            ...
            title="New file"
          >
            <HugeiconsIcon icon={FileAddIcon} strokeWidth={1.75} size={13} />
          </Button>
          <Button
            variant="ghost"
            size="icon"
            ...
            title="New folder"
          >
            <HugeiconsIcon icon={FolderAddIcon} strokeWidth={1.75} size={13} />
          </Button>
          <Button
            variant="ghost"
            size="icon"
            ...
            title="Refresh"
          >
            <Refresh variant="Linear" color="currentColor" size={12} />
          </Button>
        </div>
