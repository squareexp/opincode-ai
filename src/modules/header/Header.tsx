...
import { GridViewIcon, LayoutTwoColumnIcon, LayoutTwoRowIcon, SidebarLeftIcon } from '@hugeicons/core-free-icons';
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
...
export function Header({
  ...
  const settingsButton = (
    <Button
      ...
      title="Settings"
    >
      <Setting2 variant="Linear" size={15}  color="currentColor"/>
    </Button>
  );
  ...
  return (
    ...
    >
      <div className="flex shrink-0 items-center gap-0.5">
        ...
        >
          <HugeiconsIcon icon={SidebarLeftIcon} strokeWidth={1.75} size={18} />
        </Button>
        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <Button
              ...
              disabled={!canSplit}
            >
              <HugeiconsIcon icon={GridViewIcon} strokeWidth={1.75} size={16} />
            </Button>
          </DropdownMenuTrigger>
