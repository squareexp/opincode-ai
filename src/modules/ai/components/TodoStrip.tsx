import { TickSquare, Stop } from 'iconsax-react';
    ...
    >
      <span className="mt-[2px] inline-flex size-3.5 shrink-0 items-center justify-center">
        {isInProgress ? (
          ...
          <TickSquare variant="Linear" size={14} color="currentColor" className="shrink-0" />
        ) : (
          <Stop variant="Linear" size={14} color="currentColor" className="shrink-0" />
        )}
      </span>
      <span
        className={cn(
