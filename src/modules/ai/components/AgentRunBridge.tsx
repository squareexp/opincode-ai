...
function Bridge({
  ...
  // YOLO mode: auto-approve all pending tool calls immediately.
  // We track which approvalIds have already been auto-approved to avoid
  // calling addToolApprovalResponse twice for the same id.
