...
import { CodeIcon, HashtagIcon, Key01Icon, TerminalIcon } from '@hugeicons/core-free-icons';
      ...
      <AnimatePresence initial={false}>
        {commands.map((cmd) => (
          <motion.div
            ...
            title={cmd.label}
          >
            <HugeiconsIcon icon={cmd.icon} strokeWidth={1.75} 
              size={11}
        ...
        {snippets.map((s) => (
          ...
          >
            <HugeiconsIcon icon={HashtagIcon} strokeWidth={1.75}
              size={11}
