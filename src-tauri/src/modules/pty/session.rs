...
const AGENT_EVENT: &str = "opincode:agent-signal";
...
const OVERFLOW_NOTICE: &[u8] =
    b"\x1bc\x1b[2m[opincode: dropped output due to backpressure]\x1b[0m\r\n";
...
pub fn spawn(
    ...
    thread::Builder::new()
        .name("opincode-pty-flusher".into())
        .spawn(move || {
